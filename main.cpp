...
class ComputeApplication {
 ...
 public:
  ...
  debugReportCallbackFn(VkDebugReportFlagsEXT flags,
  ...
  void createInstance() {
    ...
    */
    if (enableValidationLayers) {
      ...
      createInfo2.pfnCallback = &debugReportCallbackFn;
      ...
      VK_CHECK_RESULT(vkCreateDebugReportCallbackEXT(
          instance, &createInfo2, NULL, &debugReportCallback));
    }
  }
  ...
  void createComputePipeline() {
    ...
    */
    ...
    uint32_t* code = readFile(filelength, SHADERDIR "comp.spv");
